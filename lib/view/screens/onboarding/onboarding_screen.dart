                                ...
                                onBoardingList.selectedIndex == 0 || onBoardingList.selectedIndex == 2
                                    ...
                                    : TextButton(
                                        ...
                                        child: Text(
                                          ...
                                          style: Theme.of(context).textTheme.displaySmall!.copyWith(color: Theme.of(context).hintColor.withOpacity(0.7)),
                                        )),
      ...
      indicators.add(
        Container(
          ...
          decoration: BoxDecoration(
            color: i == Provider.of<OnBoardingProvider>(context).selectedIndex ? Theme.of(context).primaryColor : Theme.of(context).hintColor.withOpacity(0.7),
